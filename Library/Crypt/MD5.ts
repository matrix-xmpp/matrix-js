...
module Matrix.Crypt.MD5 {
    ...
    * strings.
    */
    export function hexdigest(s: string) {
        return binl2hex(core_md5(str2binl(s), s.length * chrsz));
    }

    export function b64digest(s: string) {
    ...
    export function hmac_hexdigest(key, data) {
        return binl2hex(core_hmac_md5(key, data));
    }

    export function hmac_b64digest(key, data) {
        return binl2b64(core_hmac_md5(key, data));
    }

    export function hmac_hash(key, data) {
